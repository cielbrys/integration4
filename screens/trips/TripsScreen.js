...
export default function TripsScreen({ navigation }) {
  ...
  return useObserver(() => (
    ...
    <View style={styles.main}>
        ...
        <TouchableOpacity style={styles.latest} onPress={()=> goToDetail(latestTrip)}>
        <View style={styles.latestTop}> 
          <Text style={styles.latestName}>{latestTrip.name}</Text>
            <Pijl/>
        </View>
       <View style={styles.latestMid}>
       <View style={styles.latestStat}><Timer/><Text style={styles.lastestText}>{latestTrip.duration}h</Text></View>
       <View style={styles.latestStat}><Pinned/><Text style={styles.lastestText}>{latestTrip.duration}</Text></View>
       </View>
       <View style={styles.latestStat}><Location/><Text style={styles.lastestText}>{latestTrip.distance} {uiStore.currentUser.system}</Text></View>
        </TouchableOpacity>
        ...
        <View style={styles.all}>
          {trips.map((trip)=>(
            <View style={styles.trip}>
              ...
              <View style={styles.stat}><TimerSmall/><Text style={styles.text}>{trip.duration}h</Text></View>
              <View style={styles.stat}><LocationSmall/><Text style={styles.text}>{trip.distance} {uiStore.currentUser.system}</Text></View>
        </View>
